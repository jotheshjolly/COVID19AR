...
/// of the object.
/// </summary>
public class SimpleARScaleInteractable : ARBaseGestureInteractable
{
    ...
    {   
        m_CurrentScaleRatio += sensitivity * (gesture.GapDelta / Screen.dpi);
        ...
        {
            // scale too far beyond the limit
        } else {
