...
public class GetCountries : MonoBehaviour
{
        ...
        if(req.isDone) {
            ...
            for(int i = 0; i < data.countries.Count; i++){
                if(data.countries[i].country.ToLower() != "world") {
                    ...
                    Text casesText = newButton.transform.Find("Confirmed").transform.Find("ConfirmedData").GetComponent<Text>();
                    ...
                    Text deathsText = newButton.transform.Find("Deaths").transform.Find("DeathData").GetComponent<Text>();
                    ...
                    Text recoveredText = newButton.transform.Find("Recovered").transform.Find("RecoveredData").GetComponent<Text>();
    ...
    private void setImage(GameObject newButton, string iso, int i) {
        Image countryImage = newButton.transform.Find("CountryFlag").GetComponent<Image>();
        ...
        if(!countryImage.sprite) newButton.transform.Find("CountryFlag").gameObject.SetActive(false);
    }
}
